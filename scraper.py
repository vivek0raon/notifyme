...
async def fetch_new_job_details(processed_ids):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.goto("https://tp.bitmesra.co.in/", timeout=180000, wait_until="domcontentloaded")
            ...
            for job in new_jobs:
                ...
                await page.goto(f"https://tp.bitmesra.co.in/job/info/{job['id']}", timeout=180000, wait_until="domcontentloaded")
                await page.wait_for_load_state("domcontentloaded")
...
async def fetch_new_notifications(processed_ids):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.goto("https://tp.bitmesra.co.in/newsevents", timeout=180000, wait_until="domcontentloaded")
            await page.wait_for_load_state("domcontentloaded")
